...
function setMask(el, mask) {
    ...
    if (loading && loading === "lazy") el.addEventListener("load", ()=>{
        console.log("load");
        gsap.fromTo(el, {
            clipPath: mask.start
        }, {
...
function initContactFormUi() {
    ...
    const formEl = formWrapper.querySelector(".contact-form"), imgEl = formWrapper.querySelector(".contact-img_wrapper"), closeBtn = formWrapper.querySelector(".button.is-modal-close");
