...
},{"./modules/staggerText":"h1EYx","./modules/playVideoOnScroll":"gWHEb","./modules/menu":"gw7wn"}],"h1EYx":[function(require,module,exports) {
...
function setStaggerText() {
    ...
    textBlocks.forEach((el)=>{
        ...
        createScrollTrigger(el, words1, startVal, endVal, withScrollTrigger);
    });
}
...
},{}],"gWHEb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initMenu() {
    ...
    if (!menuItems) return;
    const menuWrapper = document.querySelector(".menu-wrapper"), itemsWrapper = menuWrapper.querySelector(".menu-inner"), imgsWrapper = menuWrapper.querySelector(".menu-img-wrapper"), menuTrigger = document.querySelector(".button.menu");
