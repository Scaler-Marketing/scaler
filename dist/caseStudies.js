...
})({"97Tfc":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "108bf2173d7c9bca";
"use strict";
...
},{}],"l06oV":[function(require,module,exports) {
function initCaseStudyHeroSection() {
    if (!document.querySelector(".section-case-study_hero")) return;
    const titleWrapper = document.querySelector(".case-study_title"), marquee = titleWrapper.querySelector(".marquee"), dataItems = document.querySelectorAll(".case-study_info");
    gsap.set(marquee, {
        yPercent: 100
    });
    gsap.set(document.querySelectorAll(".case-study_info-label"), {
        yPercent: 100
    });
    gsap.set(document.querySelectorAll(".case-study_info-data"), {
        yPercent: 100
    });
...
function initCaseStudiesList() {
    if (!document.querySelector(".case-studies-list")) return;
...
},{}]},["97Tfc","l06oV"], "l06oV", "parcelRequire5d03")
