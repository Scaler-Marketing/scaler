...
})({"axRbR":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a67a923866a8a8ee";
"use strict";
...
},{}],"k1cWz":[function(require,module,exports) {
var _heroSlider = require("./services/heroSlider");
var _servicesList = require("./home/servicesList");
var _bulletLists = require("./modules/bulletLists");
document.fonts.ready.then(()=>{
    (0, _heroSlider.initServiceHeroSlider)();
    (0, _servicesList.initServicesList)();
    (0, _bulletLists.initBulletLists)();
});

},{"./services/heroSlider":"hxxnf","./home/servicesList":"4WFhN","./modules/bulletLists":"d4r8G"}],"hxxnf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initServiceHeroSlider", ()=>initServiceHeroSlider);
function initServiceHeroSlider() {
    ...
    images.forEach((img, i)=>{
        ...
        tl.fromTo(img.querySelector(".service-slider_img"), {
            scale: 1.1
        }, {
            scale: 1,
            duration: 1,
...
},{}],"4WFhN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d4r8G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initBulletLists", ()=>initBulletLists);
var _wrapWithElement = require("./wrapWithElement");
function initBulletLists() {
    ...
    lists.forEach((list)=>{
        ...
        if (!items) return;
        items.forEach((item)=>{
            (0, _wrapWithElement.wrapTextWithElement)(item, "div", "list-item-text");
            const line = document.createElement("div");
            line.classList.add("list-item-line");
            item.appendChild(line);
        });
        const lines = list.querySelectorAll(".list-item-line"), text = list.querySelectorAll(".list-item-text");
        gsap.set(lines, {
            xPercent: -100
        });
        gsap.set(text, {
...
},{"./wrapWithElement":"diGEG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"diGEG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "wrapTextWithElement", ()=>wrapTextWithElement);
function wrapTextWithElement(el, tag, className) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["axRbR","k1cWz"], "k1cWz", "parcelRequire5d03")
