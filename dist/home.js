...
var _testimonialsGradients = require("./home/testimonialsGradients");
...
servicesItems.forEach((item)=>{
    ...
    (0, _setLinesWrapper.setLinesWrapper)(headingLines.lines, ()=>{
        headingEls = heading.querySelectorAll(".word");
        gsap.set(headingEls, {
            yPercent: 100
        });
    });
    (0, _setLinesWrapper.setLinesWrapper)(descriptionLines.lines, ()=>{
...
(0, _testimonialsGradients.initTestimonialsGradients)();
(0, _newsSlider.initNewsSlider)();

},{"./modules/setLinesWrapper":"hPUmk","./home/brandCoreText":"8LoIf","./home/heroSequence":"dKVxY","./home/testimonialsGradients":"2V5og","./home/newsSlider":"e191i","./home/caseStudies":"lk9YL","./home/caseStudiesProgress":"aPQay"}],"hPUmk":[function(require,module,exports) {
...
},{}],"8LoIf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function setBrandCoreText() {
    ...
    (0, _setLinesWrapper.setLinesWrapper)(brandCoreText.lines, ()=>{
...
},{"../modules/setLinesWrapper":"hPUmk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dKVxY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initHeroSection() {
    ...
    (0, _setLinesWrapper.setLinesWrapper)(heroSubheadline.lines, ()=>{});
    ...
    gsap.set(".reels-video-container", {
        y: "12rem"
    });
    const tl = gsap.timeline();
...
},{"../modules/setLinesWrapper":"hPUmk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2V5og":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initTestimonialsGradients", ()=>initTestimonialsGradients);
function initTestimonialsGradients() {
    ...
    gsap.set(".testimonial-item:not(:first-child)", {
        maskImage: "radial-gradient(circle at 50% 50%, black 0%, rgba(0, 0, 0, 0) 0%)"
    });
    // Next button click
...
function transitionSlides(current, next) {
    gsap.fromTo(next, {
        maskImage: "radial-gradient(circle at 50% 50%, black 0%, rgba(0, 0, 0, 0) 5%)"
    }, {
        duration: 1,
        // ease: "expo.out",
        maskImage: "radial-gradient(circle at 50% 50%, black 100%, rgba(0, 0, 0, 0) 100%)"
    });
    gsap.fromTo(current, {
        maskImage: "radial-gradient(circle at 50% 50%, rgba(0, 0, 0, 0) 0%, black 5%)"
    }, {
        duration: 1,
        // ease: "expo.out",
        maskImage: "radial-gradient(circle at 50% 50%, rgba(0, 0, 0, 0) 100%, black 100%)"
    });
    const tl = gsap.timeline();
    tl.fromTo(next.querySelector("p"), {
        opacity: 0,
        scale: 0.8
    }, {
        opacity: 1,
        ...
        duration: 1,
        ease: "expo.out"
    }).fromTo(next.querySelector(".testimonials-source"), {
        opacity: 0,
        yPercent: 100
    }, {
        opacity: 1,
...
function initCaseStudiesProgress() {
    const wrapper = document.querySelector(".case-studies-progress-inner"), progressBar = document.querySelector(".case-studies-progress"), item = progressBar.querySelector(".case-studies-progress-item"), totalCaseStudies = document.querySelectorAll(".case-study-item-link").length, scroller = document.querySelector(".case-studies-scroll");
