...
})({"lnI0z":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "12aaf213d4b0f008";
"use strict";
...
},{}],"kXJeY":[function(require,module,exports) {
// Scrub animation ================================================ //
...
function updateImageSequenceCount(file) {
    ...
    if (allImagesCount === 0) //$('.loading-disable').click();
    setTimeout(function() {
        lenis.resize();
    }, 500);
}
...
function initCanvas(section, canvas, prefix, suffix, frames, device) {
    ...
    for(var i = 0; i < frameCount; i++){
        ...
        img.onload = function() {
            ...
            if (allImagesCount === 0) initCanvasAnimations(section, images, context, canvas);
        };
...
},{}]},["lnI0z","kXJeY"], "kXJeY", "parcelRequire5d03")
